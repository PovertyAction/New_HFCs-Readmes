...
You will need to either create the remaining do files needed to set globals, import raw data (this can be downloaded from the server if you are using SurveyCTO), conduct preliminary cleaning, and generate any outcome variables of interest.
